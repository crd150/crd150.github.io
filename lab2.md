...
Note that this assignment relies on *cacounty*, which we created in the lab guide.  Copy and paste the code that creates this object in the beginning of your R Markdown because you will need it to successfully knit your document.
