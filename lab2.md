...
date: <h4 style="font-style:normal">April 6, 2022</h4>
output: 
  html_document:
    toc: true
    toc_depth: 3
...
<p class="comment">**Assignment 2 is due by 2:00 pm, April 13 on Canvas.**   See [here](https://crd150.github.io/hw_guidelines.html) for assignment guidelines. You must submit an `.Rmd` file and its associated `.html` file. Name the files: yourLastName_firstInitial_asgn02. For example: brazil_n_asgn02.</p>    
