...
We will first obtain tabular data that are used in Lab 2. These data are for marital status and educational attainment at the county level  The guide will also describe how to download shapefiles.
...
13. Unzip the folder you downloaded. The unzipped folder should contain two files. A csv file containing your data and a txt file containing meta data.  The record layout/codebook for the file can also be found [here](https://raw.githubusercontent.com/crd150/data/master/nhgis0086_ds225_20165_2016_county_codebook.txt).  
