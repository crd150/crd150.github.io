...
## 10 06001404502, CA 6001404502. 06001404502                            4.90
## # ... with 103 more rows
```
...
```
## # A tibble: 113 x 16
##    `Census Tract.x` `FIPS Code` `Formatted FIPS.… `Median leverage ratio …
##    <chr>                  <dbl> <chr>             <chr>                   
##  1 06001409000, CA  6001409000. 06001409000       3.19                    
##  2 06001401700, CA  6001401700. 06001401700       3.07                    
##  3 06001408100, CA  6001408100. 06001408100       3.11                    
...
## 10     3.10 Not Designated                  8.13  4.90    133068    6.00e9
## # ... with 103 more rows
```
