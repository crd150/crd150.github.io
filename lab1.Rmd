...
Don't worry about all those messages.  Unless you get a message in red that indicates there is an error (like we saw above when we typed in `hello world`), you should be fine.
