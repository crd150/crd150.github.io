...
An assignmnent `.Rmd` template can be found [here](https://raw.githubusercontent.com/crd150/data/master/assignment_template.Rmd).  You can use this template for every assignment or create your own R Markdown document using the directions below.
...
You won't need anything including and below "### RMarkdown" - just delete that text.  Instead, you will fill it in with your assignment answers.  Name the file: yourLastName_firstInitial_asgnXX.Rmd example: brazil_n_asgn01.Rmd
...
2. Open up the R Markdown assignment template linked above or create your own R Markdown document.
2. In this documnent, answer all the assignment questions located at the end of the guide.
* Most of the questions will ask you to run code.  Show that code in an R Markdown chunk. Make sure it works.  If it doesnt, then partial to no credit.  
