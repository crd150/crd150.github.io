...
10. Let's bring the csv file into R. We covered how to read in data into R in [Lab 2](https://crd150.github.io/lab2.html#Reading_data). If you're having trouble downloading the file, I uploaded it onto Canvas (Files - Week 3 - Lab). Make sure your [working directory is pointed to the folder containing the file](https://crd150.github.io/lab2.html#Reading_data). Then read in the file using the function `read_csv()`.
