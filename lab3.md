...
date: <h4 style="font-style:normal">January 21, 2021</h4>
output: 
  html_document:
    toc: true
    toc_depth: 3
...
<p class="comment">**Assignment 3 is due by 12:00 pm, January 28th on Canvas.**  See [here](https://crd150.github.io/hw_guidelines.html) for assignment guidelines.  You must submit an `.Rmd` file and its associated `.html` file. Name the files: yourLastName_firstInitial_asgn03. For example: brazil_n_asgn03.</p>
...
## $ tpoprE   <dbl> 271382, 17420, 8907, 1142251, 17977, 543194, 444829, 63912, …
## $ tpoprM   <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
## $ nhwhiteE <dbl> 75037, 13935, 6920, 500592, 11173, 227369, 197993, 43679, 93…
## $ nhwhiteM <dbl> 140, 56, 6, 537, 33, 248, 222, 15, 148, 52, 1010, 230, 208, …
## $ nhblkE   <dbl> 7812, 253, 136, 95892, 141, 15311, 8409, 472, 59, 454, 14469…
## $ nhblkM   <dbl> 432, 51, 26, 1240, 39, 489, 418, 40, 70, 80, 1853, 162, 335,…
## $ nhasnE   <dbl> 19650, 210, 99, 188237, 325, 29284, 23882, 967, 363, 1754, 2…
## $ nhasnM   <dbl> 528, 91, 119, 1851, 80, 860, 548, 130, 257, 172, 2024, 452, …
## $ hispE    <dbl> 161814, 1963, 1291, 292298, 4020, 251259, 201837, 15958, 386…
## $ hispM    <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
```
...
## $ NAME             <chr> "Merced County, California", "Mariposa County, Calif…
## $ tpoprE           <dbl> 271382, 17420, 8907, 1142251, 17977, 543194, 444829,…
## $ tpoprM           <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
## $ nhwhiteE         <dbl> 75037, 13935, 6920, 500592, 11173, 227369, 197993, 4…
## $ nhwhiteM         <dbl> 140, 56, 6, 537, 33, 248, 222, 15, 148, 52, 1010, 23…
## $ nhblkE           <dbl> 7812, 253, 136, 95892, 141, 15311, 8409, 472, 59, 45…
## $ nhblkM           <dbl> 432, 51, 26, 1240, 39, 489, 418, 40, 70, 80, 1853, 1…
## $ nhasnE           <dbl> 19650, 210, 99, 188237, 325, 29284, 23882, 967, 363,…
## $ nhasnM           <dbl> 528, 91, 119, 1851, 80, 860, 548, 130, 257, 172, 202…
## $ hispE            <dbl> 161814, 1963, 1291, 292298, 4020, 251259, 201837, 15…
## $ hispM            <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
## $ County           <chr> "Merced", "Mariposa", "Modoc", "Contra Costa", "Inyo…
## $ `Formatted FIPS` <chr> "=\"06047\"", "=\"06043\"", "=\"06049\"", "=\"06013\…
## $ pcol             <dbl> 13.79, 24.56, 15.19, 42.35, 27.17, 17.07, 34.16, 15.…
```


Note that if you have two variables with the same name in both files, R will attach a *.x* to the variable name in *ca* and a *.y* to the variable name in *ca.pm*.  For example, if you have a variable named *Mariah* in both files, *cacounty* will contain both variables and name it *Mariah.x* (the variable in *ca*) and *Mariah.y* (the variable in *ca.pm*).  Try to avoid having variables with the same names in the two files you want to merge. 
...
a. Use the Census API to bring in 1-year ACS estimates of median housing values and median gross rent for California counties in 2018.  Do the same for 2019 and merge these files together using their GEOID. Filter to keep just Butte county. (3 points)

b. Take the difference between the 2018 and 2019 median housing and median gross rent values.  Did housing values go up in Butte county? What about rent? (3 points)
