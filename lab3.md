...
## $ pbachp            <dbl> 48.67, 38.40, 18.10, 28.32, 19.82, 14.88, 43.33, 15.…
## $ TimeFrame         <chr> "2016-2020", "2016-2020", "2016-2020", "2016-2020", …
...
## $ NAME     <chr> "Alameda County, California", "Alpine County, California", "B…
## $ tpoprE   <dbl> 1661584, 1159, 223344, 21491, 1147788, 190345, 990204, 136101…
## $ tpoprM   <dbl> NA, 172, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
## $ nhwhiteE <dbl> 508583, 595, 158924, 7482, 489135, 146919, 284169, 99861, 183…
## $ nhwhiteM <dbl> 886, 120, 309, 25, 1486, 262, 467, 430, 134, 1229, 198, 62, 1…
## $ nhblkE   <dbl> 167316, 10, 3778, 263, 94463, 1439, 43660, 1314, 4317, 45312,…
## $ nhblkM   <dbl> 1387, 23, 316, 61, 1509, 203, 1101, 224, 200, 1039, 434, 68, …
## $ nhasnE   <dbl> 515105, 6, 10350, 160, 196904, 9023, 102986, 3829, 2375, 4159…
## $ nhasnM   <dbl> 2453, 9, 507, 85, 2267, 470, 1291, 338, 193, 1214, 467, 62, 2…
## $ hispE    <dbl> 369546, 183, 37585, 12840, 295791, 24773, 528293, 16228, 1528…
## $ hispM    <dbl> NA, 111, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, …
```
...
## Rows: 58
## Columns: 21
## $ GEOID             <chr> "06001", "06003", "06007", "06011", "06013", "06017"…
## $ NAME              <chr> "Alameda County, California", "Alpine County, Califo…
## $ tpoprE            <dbl> 1661584, 1159, 223344, 21491, 1147788, 190345, 99020…
## $ tpoprM            <dbl> NA, 172, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
## $ nhwhiteE          <dbl> 508583, 595, 158924, 7482, 489135, 146919, 284169, 9…
## $ nhwhiteM          <dbl> 886, 120, 309, 25, 1486, 262, 467, 430, 134, 1229, 1…
## $ nhblkE            <dbl> 167316, 10, 3778, 263, 94463, 1439, 43660, 1314, 431…
## $ nhblkM            <dbl> 1387, 23, 316, 61, 1509, 203, 1101, 224, 200, 1039, …
## $ nhasnE            <dbl> 515105, 6, 10350, 160, 196904, 9023, 102986, 3829, 2…
## $ nhasnM            <dbl> 2453, 9, 507, 85, 2267, 470, 1291, 338, 193, 1214, 4…
## $ hispE             <dbl> 369546, 183, 37585, 12840, 295791, 24773, 528293, 16…
## $ hispM             <dbl> NA, 111, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,…
## $ GeoID_Description <chr> "County", "County", "County", "County", "County", "C…
## $ county            <chr> "Alameda", "Alpine", "Butte", "Colusa", "Contra Cost…
## $ SitsinState       <chr> "CA", "CA", "CA", "CA", "CA", "CA", "CA", "CA", "CA"…
## $ GeoID_Formatted   <chr> "=\"06001\"", "=\"06003\"", "=\"06007\"", "=\"06011\…
## $ pbachp            <dbl> 48.67, 38.40, 28.32, 14.88, 43.33, 35.24, 22.03, 30.…
## $ TimeFrame         <chr> "2016-2020", "2016-2020", "2016-2020", "2016-2020", …
## $ GeoVintage        <dbl> 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020, 2020…
## $ Source            <chr> "Census", "Census", "Census", "Census", "Census", "C…
## $ Location          <chr> "California (State)", "California (State)", "Califor…
...
##  Length:58          Length:58          Min.   :    1159   Min.   :12.65  
##  Class :character   Class :character   1st Qu.:   47908   1st Qu.:18.12  
##  Mode  :character   Mode  :character   Median :  185462   Median :24.25  
##                                        Mean   :  678380   Mean   :28.09  
##                                        3rd Qu.:  700270   3rd Qu.:36.34  
##                                        Max.   :10040682   Max.   :60.16  
##      pwhite          pblack            pasian           phisp      
##  Min.   :10.19   Min.   : 0.1035   Min.   : 0.000   Min.   : 7.44  
##  1st Qu.:34.48   1st Qu.: 1.0887   1st Qu.: 1.891   1st Qu.:15.34  
##  Median :51.15   Median : 1.8042   Median : 4.502   Median :25.72  
##  Mean   :52.97   Mean   : 2.9403   Mean   : 7.488   Mean   :30.95  
##  3rd Qu.:71.03   3rd Qu.: 3.2150   3rd Qu.: 7.884   3rd Qu.:44.95  
##  Max.   :88.37   Max.   :13.3282   Max.   :37.433   Max.   :84.66
```
...
d. How many years will it take for a household to pay off a house in Yolo County in 2017-21? (1 point)
